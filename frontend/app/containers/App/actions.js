import { REQUEST_GET_NOTIFICATION_LIST, REQUEST_GET_NOTIFICATION_LIST_SUCCESS,
  ...
  REQUEST_ERROR, REQUEST_SUCCESS, REQUEST_CLEAR_NOTIFICATION_LIST, DELETE_NOTIFICATION, DELETE_NOTIFICATIONS_BULK
} from './constants';
 ...
 export function requestNotifications(page = "", readed = null) {
  ...
  export function deleteNotificationsBulkAction(ids) {
    return { 
      type: DELETE_NOTIFICATIONS_BULK, 
      ids 
    };
  }
