...
export const MARK_NOTIFICATION_AS_READ = 'app/App/MARK_NOTIFICATION_AS_READ';

export const DELETE_NOTIFICATION = 'app/App/DELETE_NOTIFICATION';
export const DELETE_NOTIFICATION_SUCCESS = 'app/App/DELETE_NOTIFICATION_SUCCESS';

export const DELETE_NOTIFICATIONS_BULK = 'app/App/DELETE_NOTIFICATIONS_BULK';
export const DELETE_NOTIFICATIONS_BULK_SUCCESS = 'app/App/DELETE_NOTIFICATIONS_BULK_SUCCESS';
