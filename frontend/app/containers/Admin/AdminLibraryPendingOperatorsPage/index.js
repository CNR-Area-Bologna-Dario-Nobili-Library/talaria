...
import {requestGetLibrary, requestGetLibraryPendingOperators,requestRemoveLibraryPendingOperator} from '../actions';
...
function AdminLibraryPendingOperatorsPage(props) {
  ...
  useEffect(() => {         
    ...
    async function removePendingOperator(pendingid) {          
      ...
      let msg=intl.formatMessage({id: "app.containers.AdminLibraryPendingOperatorsPage.askRemoveOperatorMessage"})
