...
class UserObserver extends BaseObserver
{
    protected $rules = [
        ...
        'user_service_email'=> 'sometimes|required|email|max:255',

        'nationality' => 'nullable|integer|exists:countries,id',
        'preflang' => 'nullable|max:255', 
    ...
    protected function setConditionalRules($model){
        ...
        foreach(['email','user_service_email'] as $field)
        {
    ...
    public function creating($model)
    {
        ...
        $model->status=config("constants.status.enabled");       
         ...
         //default values
          $model->user_service_email=$model->email;          
          $model->preflang=$model->preflang?$model->preflang:app()->getLocale();   //if no UI lang it takes default APP (backend) language
