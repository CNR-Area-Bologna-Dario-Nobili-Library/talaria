...
class LibraryOperatorUpdatePermissionsNotification extends MandatoryNotification
{
    use Queueable;
     ...
     * @return void
     */
    //NOTE: model is $obj=["user"=>$user,"library"=>$lib, "abilities"=>$abilities]; 
    ...
    {                
        ...
        $abilities=$this->object->abilities; //this is a comma separated strings of permissions
